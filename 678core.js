...
//
// 【为什么是 47 个】榜的目标规模是 40~50 行（你定的）。而且 AI 现在**也要
// 满 10 场才上榜**（和真人同一道门槛），所以名单人数就是榜的长期上限 ——
// 47 个意味着榜最终稳定在 47 行 AI，再加上真人。
//
// 原来是 115 个，为的是把「前 100 名」撑满。但那套的前提是 AI 一上线就有分，
// 现在起点统一回 1000、靠场次慢慢爬（见 server.js 的 ladPersona），一次性
// 摆 115 个「刚开天梯就人满为患」本身就假。
//
...
D678.LAD_AI_NAMES = [
    //--- 中文 33 ---
    // 打牌口气
    '要牌狂魔', '停牌保平', '逢七必爆', '见八就停', '暗牌先生',
    '荷官很偏心', '点数刚刚好',
    // 运气玄学
    '欧皇本人', '非酋附体', '玄不救非', '拜过关二爷', '手感发烫',
    '天选之人',
    // 天梯人格
    '常年第八名', '掉分大师', '上分好难', '稳如老狗', '我不是AI',
    '查无此人',
    // 生活切片
    '午休摸鱼中', '加班到十点', '摸鱼冠军', '老板在身后', '厕所五分钟',
    '排队等奶茶',
    // 设备与网络
    '网速堪忧', '电量告急', '充电线在哪',
    // 心态
    ...
    //--- 英文 14 ---
    // 牌桌术语
    'AllIn666', 'Bet7Win', 'Bust8', 'HitMe7',
    // 运气
    'LuckyDog', 'RNGesus', 'Unlucky7',
    // 英文名 + 数字
    'Mike520', 'Coco1024', 'Leo1995',
    // 游戏黑话
    'EZWin7', 'NoobKing', 'TiltKing',
    // 生活 / 设备
    'Lagging',
];
