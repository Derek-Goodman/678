...
//
// 【为什么是 115 个】榜的目标规模是 100 行（LAD_BOARD_N）。AI 现在**也要
// 满 10 场才上榜**（和真人同一道门槛），所以名单人数就是榜的长期上限 ——
// 115 个意味着榜最终能撑满 100 行，再加上真人。
//
// 【2026-08-07 砍到 47 又改回来了】砍的理由是「一次性摆 115 个＝刚开天梯就
// 人满为患」。但那是把两件事混一起了：**门槛才是控制上线初人数的闸门，名单
// 大小只决定天花板**。实测两条曲线形状一模一样、只是等比放大：
//
//   上线后        47 名单    115 名单
//   0.5 天           0          0
//   1 天            28         64
...
//   4 天            47        115（满）
//
// 所以爬坡感靠 10 场门槛自己就有了，名单砍小只是把天花板一起砍了。
// 115 这一版是旧名单原样恢复（git 0190525），**47 个是它的完整子集** ——
// 恢复不是「换一批人」，现有那 47 行的分数和历史一个都没动，只多进来 68 人。
//
